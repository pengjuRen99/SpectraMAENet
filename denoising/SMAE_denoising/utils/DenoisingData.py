...
class RamanDataset(Dataset):
    ...
    def __getitem__(self, index):       
        ...
        sample = {'input_spectrum': float_transform(input_spectrum), 'output_spectrum': float_transform(output_spectrum)}   # evaluate 
        # sample = float_transform(input_spectrum)      # train
